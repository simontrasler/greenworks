...
void InitUgcMatchingTypes(v8::Local<v8::Object> exports) {
  ...
  SET_TYPE(ugc_matching_type, "ItemsReadyToUse", k_EUGCMatchingUGCType_Items_ReadyToUse);
  ...
  SET_TYPE(ugc_matching_type, "IntegratedGuides", k_EUGCMatchingUGCType_IntegratedGuides);
  SET_TYPE(ugc_matching_type, "UsableInGame", k_EUGCMatchingUGCType_UsableInGame);
  SET_TYPE(ugc_matching_type, "ControllerBindings", k_EUGCMatchingUGCType_ControllerBindings);
...
void InitUgcQueryTypes(v8::Local<v8::Object> exports) {
  ...
  SET_TYPE(ugc_query_type, "RankedByPublicationDate", k_EUGCQuery_RankedByPublicationDate);
  SET_TYPE(ugc_query_type, "AcceptedForGameRankedByAcceptanceDate", k_EUGCQuery_AcceptedForGameRankedByAcceptanceDate);
  SET_TYPE(ugc_query_type, "RankedByTrend", k_EUGCQuery_RankedByTrend);
  SET_TYPE(ugc_query_type, "FavoritedByFriendsRankedByPublicationDate", k_EUGCQuery_FavoritedByFriendsRankedByPublicationDate);
  SET_TYPE(ugc_query_type, "CreatedByFriendsRankedByPublicationDate", k_EUGCQuery_CreatedByFriendsRankedByPublicationDate);
  SET_TYPE(ugc_query_type, "RankedByNumTimesReported", k_EUGCQuery_RankedByNumTimesReported);
  SET_TYPE(ugc_query_type, "CreatedByFollowedUsersRankedByPublicationDate", k_EUGCQuery_CreatedByFollowedUsersRankedByPublicationDate);
  SET_TYPE(ugc_query_type, "NotYetRated", k_EUGCQuery_NotYetRated);
  SET_TYPE(ugc_query_type, "RankedByTotalVotesAsc", k_EUGCQuery_RankedByTotalVotesAsc);
  SET_TYPE(ugc_query_type, "RankedByVotesUp", k_EUGCQuery_RankedByVotesUp);
  SET_TYPE(ugc_query_type, "RankedByTextSearch", k_EUGCQuery_RankedByTextSearch);
  Nan::Persistent<v8::Object> constructor;
...
void InitUserUgcListSortOrder(v8::Local<v8::Object> exports) {
  ...
  SET_TYPE(ugc_list_sort_order, "CreationOrderDesc", k_EUserUGCListSortOrder_CreationOrderDesc);
  SET_TYPE(ugc_list_sort_order, "CreationOrderAsc", k_EUserUGCListSortOrder_CreationOrderAsc);
  SET_TYPE(ugc_list_sort_order, "TitleAsc", k_EUserUGCListSortOrder_TitleAsc);
  SET_TYPE(ugc_list_sort_order, "LastUpdatedDesc", k_EUserUGCListSortOrder_LastUpdatedDesc);
  SET_TYPE(ugc_list_sort_order, "SubscriptionDateDesc", k_EUserUGCListSortOrder_SubscriptionDateDesc);
  SET_TYPE(ugc_list_sort_order, "VoteScoreDesc", k_EUserUGCListSortOrder_VoteScoreDesc);
  SET_TYPE(ugc_list_sort_order, "ForModeration", k_EUserUGCListSortOrder_ForModeration);
  Nan::Persistent<v8::Object> constructor;
...
NAN_METHOD(FileShare) {
  ...
  Nan::AsyncQueueWorker(new greenworks::FileShareWorker(success_callback, error_callback, file_name));
...
NAN_METHOD(PublishWorkshopFile) {
  ...
  if (info.Length() < 6 || !info[0]->IsObject() || !info[1]->IsString() || !info[2]->IsString() || !info[3]->IsString() || !info[4]->IsString() ||
      !info[5]->IsFunction()) {
    THROW_BAD_ARGS("Bad arguments");
  }
  ...
  if (!app_id.ToLocalChecked()->IsInt32() || !tags.ToLocalChecked()->IsArray()) {
    THROW_BAD_ARGS("The object parameter must have 'app_id' and 'tags' field.");
  }
  ...
  Nan::AsyncQueueWorker(
      new greenworks::PublishWorkshopFileWorker(success_callback, error_callback, Nan::To<int32>(app_id.ToLocalChecked()).FromJust(), properties));
  info.GetReturnValue().Set(Nan::Undefined());
}
...
NAN_METHOD(UpdatePublishedWorkshopFile) {
  ...
  if (info.Length() < 7 || !info[0]->IsObject() || !info[1]->IsString() || !info[2]->IsString() || !info[3]->IsString() || !info[4]->IsString() ||
  ...
  Nan::AsyncQueueWorker(new greenworks::UpdatePublishedWorkshopFileWorker(success_callback, error_callback, published_file_id, properties));
  info.GetReturnValue().Set(Nan::Undefined());
}

NAN_METHOD(UGCGetItems) {
  Nan::HandleScope scope;
  if (info.Length() < 4 || !info[0]->IsObject() || !info[1]->IsInt32() || !info[2]->IsInt32() || !info[3]->IsFunction()) {
    THROW_BAD_ARGS("Bad arguments");
  }
  Nan::MaybeLocal<v8::Object> maybe_opt = Nan::To<v8::Object>(info[0]);
  auto options = maybe_opt.ToLocalChecked();
  ...
  if (!app_id.ToLocalChecked()->IsInt32() || !page_num.ToLocalChecked()->IsInt32()) {
    THROW_BAD_ARGS("The object parameter must have 'app_id' and 'page_num' fields.");
  }
...
NAN_METHOD(UGCGetUserItems) {
  Nan::HandleScope scope;
  if (info.Length() < 5 || !info[0]->IsObject() || !info[1]->IsInt32() || !info[2]->IsInt32() || !info[3]->IsInt32() || !info[4]->IsFunction()) {
    THROW_BAD_ARGS("Bad arguments");
  }
  Nan::MaybeLocal<v8::Object> maybe_opt = Nan::To<v8::Object>(info[0]);
  auto options = maybe_opt.ToLocalChecked();
...
NAN_METHOD(UGCSynchronizeItems) {
  ...
  Nan::AsyncQueueWorker(new greenworks::SynchronizeItemsWorker(success_callback, error_callback, download_dir,
                                                               Nan::To<int32>(app_id.ToLocalChecked()).FromJust(),
...
NAN_METHOD(UGCUnsubscribe) {
  ...
  PublishedFileId_t unsubscribed_file_id = utils::strToUint64(*(Nan::Utf8String(info[0])));
  Nan::Callback *success_callback = new Nan::Callback(info[1].As<v8::Function>());
  Nan::Callback *error_callback = nullptr;
  ...
  Nan::AsyncQueueWorker(new greenworks::UnsubscribePublishedFileWorker(success_callback, error_callback, unsubscribed_file_id));
  info.GetReturnValue().Set(Nan::Undefined());
}
...
NAN_METHOD(UGCSubscribe) {
  ...
  PublishedFileId_t subscribed_file_id = utils::strToUint64(*(Nan::Utf8String(info[0])));
  Nan::Callback *success_callback = new Nan::Callback(info[1].As<v8::Function>());
  Nan::Callback *error_callback = nullptr;
  ...
  Nan::AsyncQueueWorker(new greenworks::SubscribePublishedFileWorker(success_callback, error_callback, subscribed_file_id));
  info.GetReturnValue().Set(Nan::Undefined());
}
