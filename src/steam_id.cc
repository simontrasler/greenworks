...
NAN_METHOD(SteamID::IsPersistentGameServerAccount) {
  auto *obj = ObjectWrap::Unwrap<SteamID>(info.Holder());
  info.GetReturnValue().Set(Nan::New(obj->steam_id_.BPersistentGameServerAccount()));
}
...
NAN_METHOD(SteamID::GetAccountID) {
  auto *obj = ObjectWrap::Unwrap<SteamID>(info.Holder());
  info.GetReturnValue().Set(Nan::New<v8::Integer>(obj->steam_id_.GetAccountID()));
}

NAN_METHOD(SteamID::GetRawSteamID) {
  auto *obj = ObjectWrap::Unwrap<SteamID>(info.Holder());
  info.GetReturnValue().Set(Nan::New(utils::uint64ToString(obj->steam_id_.ConvertToUint64())).ToLocalChecked());
}
...
NAN_METHOD(SteamID::GetStaticAccountKey) {
  auto *obj = ObjectWrap::Unwrap<SteamID>(info.Holder());
  info.GetReturnValue().Set(Nan::New(utils::uint64ToString(obj->steam_id_.GetStaticAccountKey())).ToLocalChecked());
}

NAN_METHOD(SteamID::GetPersonaName) {
  auto *obj = ObjectWrap::Unwrap<SteamID>(info.Holder());
  info.GetReturnValue().Set(Nan::New(SteamFriends()->GetFriendPersonaName(obj->steam_id_)).ToLocalChecked());
}
...
NAN_METHOD(SteamID::GetRelationship) {
  auto *obj = ObjectWrap::Unwrap<SteamID>(info.Holder());
  info.GetReturnValue().Set(Nan::New(SteamFriends()->GetFriendRelationship(obj->steam_id_)));
}

NAN_METHOD(SteamID::GetSteamLevel) {
  auto *obj = ObjectWrap::Unwrap<SteamID>(info.Holder());
  info.GetReturnValue().Set(Nan::New(SteamFriends()->GetFriendSteamLevel(obj->steam_id_)));
}
